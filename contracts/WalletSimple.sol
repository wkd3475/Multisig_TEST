...
contract WalletSimple {
  ...
  function sendMultiSig(
    ...
    var operationHash = keccak256(prefix, keccak256("ETHER", toAddress, value, data, expireTime, sequenceId));
  ...
  function hashing(string name, address toAddress, uint value, bytes data, uint expireTime, uint sequenceId) public view onlySigner returns(bytes32) {
      var operationHash = keccak256(name, toAddress, value, data, expireTime, sequenceId);
